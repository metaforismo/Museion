      ...
      <header className="mt-6 overflow-hidden rounded-[2rem] border border-ink/10 bg-ink text-white shadow-[0_24px_70px_rgba(19,28,49,.16)]">
        <div className="grid lg:grid-cols-[minmax(0,1.25fr)_minmax(18rem,.75fr)]">
          <div className="p-7 sm:p-10 lg:p-12">
            ...
            <Link href={`/lessons/${course.lessonIds[0]}?course=${course.id}`} className="mt-8 inline-flex min-h-12 items-center rounded-xl bg-white px-5 py-3 text-sm font-semibold text-ink transition hover:bg-gold-soft">Start the path <span className="ml-2" aria-hidden="true">→</span></Link>
          </div>
